...
BEGIN
    ...
    -- Ïåðåâ³ðêà ³äåíòèô³êàòîðà, ÿêùî çàäàíèé
...
-- âñ³ ë³êè, ïåðøà ñòîð³íêà, 10 çàïèñ³â, ñîðòóâàííÿ çà ö³íîþ ïî çðîñòàííþ
...
-- ë³êè, ùî ïî÷èíàþòüñÿ íà "Ïàðà"
EXEC dbo.sp_GetMedicine @Name = N'Ïàðà';

-- ò³ëüêè ðåöåïòóðí³, ïî êàòåãîð³¿ "Àíòèá³îòèêè" (ïðèïóñòèìî, category_id = 3)
...
-- ïîñòà÷àëüíèêè, ùî ïî÷èíàþòüñÿ íà "Ìåä"
EXEC dbo.sp_GetSupplier @Name = N'Ìåä';

-- äðóãà ñòîð³íêà, ïî 1 çàïèñó, ñîðò ïî íàçâ³
EXEC dbo.sp_GetSupplier
    @PageSize = 1,
    @PageNumber = 2,
